<%-- 
    Document   : addCommentFail
    Created on : 2016年4月11日, 上午12:06:02
    Author     : samsung-pc
--%>
<%-- 
...
<html>
    ...
    <body>
        ...
        <fieldset>
            ...
            <legend style='color: red'>ERROR:The Comment is fail to add.</legend>
            ...
            <p>Comment: <jsp:getProperty name="Comment" property="comment" /></p>   
                        <p><a href='controller?sction=toyinfo&amp;toyid=<jsp:getProperty name="Comment" property="toyid" />' >Back to Toy Info Page</a></p>
        </fieldset>
        </div>
    </body>
</html>
